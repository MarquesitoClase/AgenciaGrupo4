document.addEventListener("DOMContentLoaded", () => {
  ...
  const trips = [
    ...
    },
    {
      id: "grecia-islas",
      type: ["pareja", "familia"],
      title: "Islas Griegas en ferry",
      image: "../media/images/grecia.jpg",
      alt: "Pueblo blanco y azul sobre el mar",
      location: "Atenas · Santorini · Mykonos",
      duration: "9 días · 7 noches",
      description:
        "Combinación clásica de islas para quien busca playas, atardeceres y pueblos con encanto sobre el Egeo.",
      priceFrom: "1.180 €",
      tags: ["Sol y playa", "Islas", "Europa"],
    },
    {
      id: "marruecos-kasbahs",
      type: ["aventura", "familia"],
      title: "Marruecos: kasbahs y desierto",
      image: "../media/images/africa2.jpg",
      alt: "Acantilado volcánico junto al mar",
      location: "Marrakech · Ait Ben Haddou · Erg Chebbi",
      duration: "8 días · 6 noches",
      description:
        "Riad tradicionales, noche en jaima en el desierto y ruta en 4x4 por valles y kasbahs históricas.",
      priceFrom: "990 €",
